...
public class NetworkBattle {
	...
	public NetworkBattle(GameSettings settings, GameArena gameArena, CheckerAlgorithm checker, GameStatistics statistics) {
	...
	private Point getPointIfEmptyNetwork(GameArena arena, Symbol symbol, Type type) {
		...
		return getPointIfEmptyNetwork(arena, symbol, type);
	}
}
